...
public class CharacterService {
    ...
    public CharacterReadDto patchPerson(UUID id, CharacterPatchDto characterPatchDto) {
        ...
        if (nonNull(characterPatchDto.getActor())) {
            character.setActor(translationService.toEntity(characterPatchDto.getActor()));
        }

        if (nonNull(characterPatchDto.getMovie())) {
            character.setMovie(translationService.toEntity(characterPatchDto.getMovie()));
        }
